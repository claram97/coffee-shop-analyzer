...
import databatch_pb2 as _databatch_pb2
...
class Envelope(_message.Message):
    __slots__ = ("type", "eof", "table_data", "query_request", "data_batch")
    class Opcode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        DATA_BATCH: _ClassVar[Envelope.Opcode]
    ...
    data_batch: _databatch_pb2.DataBatch
    def __init__(self, type: _Optional[_Union[Envelope.Opcode, str]] = ..., eof: _Optional[_Union[_eof_message_pb2.EOFMessage, _Mapping]] = ..., table_data: _Optional[_Union[_table_data_pb2.TableData, _Mapping]] = ..., query_request: _Optional[_Union[_query_request_pb2.QueryRequest, _Mapping]] = ..., data_batch: _Optional[_Union[_databatch_pb2.DataBatch, _Mapping]] = ...) -> None: ...
