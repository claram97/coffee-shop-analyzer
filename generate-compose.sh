...
: "${HEARTBEAT_MAX_MISSES:=8}"
: "${HEARTBEAT_STARTUP_GRACE_SECONDS:=8.0}"
: "${HEARTBEAT_ELECTION_COOLDOWN_SECONDS:=25.0}"
: "${HEARTBEAT_COOLDOWN_JITTER_SECONDS:=1.0}"
: "${FOLLOWER_DOWN_TIMEOUT_SECONDS:=20.0}"
: "${FOLLOWER_RESTART_COOLDOWN_SECONDS:=30.0}"
: "${FOLLOWER_RECOVERY_GRACE_SECONDS:=12.0}"
