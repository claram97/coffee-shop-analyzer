...
def test_q4_partition_and_template_meta(tmp_data_dir, fake_out, empty_inputs):
    ...
    # 3) mandar TX con Q4 que tiene 2 usuarios distintos
    ...
    # 5) llegan los users con Q4 -> debe emitir dos batches NEW_TRANSACTION_STORES_USERS
